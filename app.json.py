{
  "name": "D A R K B O T",
  "description": "THE DARKBOT made by @HARSH_78 special thanks to respective HellBot owner @Kraken_The_BadASS AND @H1M4AN5UOP  Join for updates related info @DARK_Bot_Support",
  "logo": "https://telegra.ph/file/e776cd3a6603176b96557.jpg",
    "keywords": [
    "telegram",
    "userbot",
    "plugin",
  ...
  "repository": "https://replit.com/@DARKHARSHOP/DARKBOT-STRING-GENERATOR/",
  "website": "https://replit.com/@DARKHARSHOP/DARKBOT-STRING-GENERATOR/",
  "success_url": "https://t.me/T",
  "env": {
    "ENV": {
    ...
    "ALIVE_NAME": {
      "description": "Fill your 
      Full name or Username like @HARSH_78 . By default it is DarkBot User",
      "value": "@Dark_bot_support",
      "required": false
    },
    "ALIVE_MSG": {
      "description": "Set Custom Alive Message When entering .dark Command.",
      "value": "😈DARK EVIL IS ALIVE😈",
      "required": false
    },
    "ALIVE_PIC": {
      "description": "Put here any telegraph media link for alive pic in .dark command.",
      "value": "https://telegra.ph/file/e776cd3a6603176b96557.jpg",
      "required": false
    },
    "BIO_MSG": {
      "description": "Put Your Telegram Bio Here Required For Auto Bio.",
      "value": "😈LEGEND'S SAY'S TO DARKBOT😈",
      "required": false
    },
    "PMPERMIT_PIC": {
